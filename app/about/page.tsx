    ...
    <main className="bg-background">
      <div className="container mx-auto px-6 pt-32 pb-24">
        ...
        <div className="mb-28 text-center">
          <h1 className="font-heading text-5xl font-light tracking-wide lg:text-6xl">About Savis Candles</h1>
          <p className="mx-auto mt-6 max-w-2xl font-body text-lg leading-relaxed text-foreground/70">
            Crafting moments of tranquility through the art of candlemaking
          </p>
        </div>

        {/* Story Section */}
        <div className="mx-auto mb-28 max-w-4xl space-y-8">
        ...
        <div className="mx-auto mb-28 max-w-4xl">
          <h2 className="mb-16 text-center font-heading text-3xl font-light tracking-wide">Our Values</h2>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="rounded-2xl bg-secondary p-16 text-center">
            <h2 className="mb-6 font-heading text-3xl font-light tracking-wide">The Art of Candlemaking</h2>
            <p className="font-body mx-auto max-w-2xl leading-relaxed text-foreground/70">
